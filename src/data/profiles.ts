...
// Movimiento Ciudadano · Primera mujer alcaldesa de GDL · 2024-2027
// ═══════════════════════════════════════════════════════════════════
const veronicaDelgadillo: Profile = {
  slug: 'veronica-delgadillo',
  candidate: {
    ...
    eleccion: 'Municipal 2027',
    diasParaEleccion: 271,
    photoInitials: 'VD',
    photoUrl: '/candidates/veronica-delgadillo.jpg',
  },
  candidateScope: {
    level: 'municipal',
    area: 'Guadalajara',
  ...
  topNews: [
    { title: 'Noticieros Televisa: Delgadillo anuncia inversión histórica en servicios municipales', source: 'Noticieros Televisa', tier: 'nacional-tv', time: '10:02 AM', sentiment: 'POSITIVA' },
    { title: 'Reforma cubre confrontación en cabildo entre MC y MORENA por resultados', source: 'Reforma', tier: 'nacional-print', time: '09:15 AM', sentiment: 'NEUTRAL' },
    { title: 'El Informador: Delgadillo destaca avances en el eje de agua de calidad', source: 'El Informador', tier: 'regional', time: '08:40 AM', sentiment: 'POSITIVA' },
  ],
  allNews: [
    { title: 'Noticieros Televisa: Delgadillo anuncia inversión histórica en servicios municipales', source: 'Noticieros Televisa', tier: 'nacional-tv', time: '10:02 AM', sentiment: 'POSITIVA', summary: 'Cobertura en horario estelar. La primera presidenta electa de GDL detalló ejes de agua, seguridad y ciudad limpia con inversión récord.' },
    { title: 'TV Azteca reporta recorrido de Delgadillo en el centro histórico', source: 'Hechos AM · TV Azteca', tier: 'nacional-tv', time: '07:20 AM', sentiment: 'POSITIVA', summary: 'Nota sobre supervisión de obras del corredor Chapultepec y encuentros con comerciantes locales.' },
    { title: 'Reforma cubre confrontación en cabildo entre MC y MORENA por resultados', source: 'Reforma', tier: 'nacional-print', time: '09:15 AM', sentiment: 'NEUTRAL', summary: 'Análisis de la sesión ordinaria donde regidores de MORENA cuestionaron los avances del gobierno emecista.' },
    { title: 'El Universal: Delgadillo consolida su liderazgo como primera alcaldesa de GDL', source: 'El Universal', tier: 'nacional-print', time: '06:45 AM', sentiment: 'POSITIVA', summary: 'Reportaje sobre el primer año de gobierno y las prioridades en materia de servicios básicos e infraestructura.' },
    { title: 'Milenio: Delgadillo lidera preferencia entre alcaldías de la ZMG', source: 'Milenio', tier: 'nacional-print', time: '08:15 AM', sentiment: 'POSITIVA', summary: 'Última medición ubica a Guadalajara con la mejor evaluación en gestión de servicios entre municipios metropolitanos.' },
    { title: 'El Informador: Delgadillo destaca avances en el eje de agua de calidad', source: 'El Informador', tier: 'regional', time: '08:40 AM', sentiment: 'POSITIVA', summary: 'Reportaje sobre el plan de sustitución de redes hidráulicas en colonias del sur y del oriente.' },
    { title: 'NTR Guadalajara: colectivos piden más acción en seguridad en Oblatos', source: 'NTR Guadalajara', tier: 'regional', time: '09:15 AM', sentiment: 'NEGATIVA', summary: 'Vecinos exigen refuerzo del programa de seguridad en colonias con alta incidencia delictiva.' },
    { title: 'UdeG Radio: foro sobre gobiernos municipales tapatíos', source: 'UdeG Radio', tier: 'digital-medio', time: '06:20 AM', sentiment: 'NEUTRAL', summary: 'Universitarios organizan foro con presencia de la alcaldesa para dialogar sobre juventudes y participación.' },
    { title: 'Influencer viraliza crítica a manejo de gasto público de Delgadillo', source: '@gdl_critico · X', tier: 'influencer', time: '05:40 AM', sentiment: 'NEGATIVA', summary: 'Publicación de creador con 180k seguidores cuestiona partidas del presupuesto de comunicación social.' },
  ],
  topics: [
    { name: 'Agua e infraestructura', mentions: 5820, sentiment: 68, positive: true },
    { name: 'Ciudad limpia', mentions: 4230, sentiment: 62, positive: true },
    { name: 'Seguridad', mentions: 3480, sentiment: -18, positive: false },
    { name: 'Oportunidades y empleo', mentions: 2810, sentiment: 55, positive: true },
    { name: 'Confrontación con MORENA', mentions: 1920, sentiment: -32, positive: false },
  ],
  wordCloud: [
    { text: 'agua', value: 100, color: '#3b82f6' },
    { text: 'guadalajara', value: 88, color: '#a855f7' },
    { text: 'servicios', value: 78, color: '#22c55e' },
    { text: 'ciudad', value: 68, color: '#a855f7' },
    { text: 'seguridad', value: 62, color: '#ef4444' },
    { text: 'obras', value: 55, color: '#22c55e' },
    { text: 'inversión', value: 50, color: '#eab308' },
    { text: 'oportunidades', value: 48, color: '#22c55e' },
    { text: 'ciudadanos', value: 44, color: '#eab308' },
    { text: 'presidenta', value: 40, color: '#ec4899' },
    { text: 'movimiento', value: 34, color: '#ff6b00' },
    { text: 'ciudadano', value: 30, color: '#ff6b00' },
    { text: 'limpia', value: 28, color: '#22c55e' },
    { text: 'colonias', value: 26, color: '#3b82f6' },
    { text: 'mujeres', value: 24, color: '#ec4899' },
    { text: 'gestión', value: 20, color: '#eab308' },
  ],
  alerts: [
    { id: 'alt-01', what: 'Menciones críticas por seguridad en colonias del oriente', who: 'Colectivos vecinales de Oblatos + NTR Guadalajara', risk: 'Medio · afecta narrativa del eje de seguridad', time: 'Hace 15 min', severity: 'orange', recommendationId: 'rec-seguridad-oblatos' },
    { id: 'alt-02', what: 'Video crítico sobre gasto de comunicación social', who: 'Creador @gdl_critico (180k seguidores)', risk: 'Medio · potencial viralización en 6h', time: 'Hace 42 min', severity: 'yellow', recommendationId: 'rec-video-critico' },
    { id: 'alt-03', what: 'Regidores MORENA anuncian nueva confrontación en cabildo', who: 'Bancada MORENA · sesión de mañana', risk: 'Bajo · disputa política normal', time: 'Hace 1 h', severity: 'blue', recommendationId: 'rec-cabildo' },
  ],
  allAlerts: [
    { id: 'alt-01', what: 'Menciones críticas por seguridad en Oblatos y colonias del oriente (+34% en la última hora, 1,980 menciones)', who: 'Colectivos vecinales del oriente + NTR Guadalajara', risk: 'Medio · afecta narrativa del eje de seguridad', zone: 'Oblatos · Guadalajara', time: 'Hace 15 min', severity: 'orange', recommendationId: 'rec-seguridad-oblatos' },
    { id: 'alt-02', what: 'Video crítico sobre gasto de comunicación social: 8,500 views en 40 minutos', who: 'Creador @gdl_critico (180k seguidores) + réplicas en TikTok', risk: 'Medio · viralización probable en 6h', zone: 'Digital', time: 'Hace 42 min', severity: 'yellow', recommendationId: 'rec-video-critico' },
    { id: 'alt-03', what: 'Regidores MORENA anuncian nueva confrontación en cabildo por resultados', who: 'Bancada MORENA · sesión ordinaria mañana 10:00 AM', risk: 'Bajo · disputa política normal en cabildo', zone: 'Cabildo GDL', time: 'Hace 1 h', severity: 'blue', recommendationId: 'rec-cabildo' },
    { id: 'alt-04', what: 'Cobertura positiva de El Informador sobre eje de agua', who: 'El Informador · sección Jalisco', risk: 'Bajo · oportunidad de amplificar mensaje', zone: 'Jalisco', time: 'Hace 2 h', severity: 'blue', recommendationId: 'rec-prensa-regional' },
    { id: 'alt-05', what: 'Reforma cuestiona resultados de MC vs. MORENA rumbo a 2027', who: 'Reforma · sección Estados', risk: 'Medio · afecta narrativa de gestión municipal', zone: 'Nacional', time: 'Hace 3 h', severity: 'yellow', recommendationId: 'rec-narrativa-2027' },
    { id: 'alt-06', what: 'Reel institucional de Delgadillo alcanza 25k views con contenido de agua', who: '@veronicadelgadillo · cuenta oficial', risk: 'Bajo · oportunidad de replicar formato exitoso', zone: 'Digital', time: 'Hace 4 h', severity: 'blue', recommendationId: 'rec-contenido' },
  ],
  recommendations: [
    { id: 'rec-seguridad-oblatos', title: 'Reforzar comunicación de estrategia de seguridad en Oblatos', category: 'crisis', urgency: 'alta', summary: 'Menciones críticas por seguridad en Oblatos crecen +34% en 1 hora. Colectivos vecinales exigen acción. Ventana de acción: próximas 6 horas.', actions: ['Publicar cronograma detallado de operativos en colonias del oriente', 'Rueda de prensa con la Comisaría municipal y titulares de gabinete', 'Recorrido con periodistas por colonias con avances del programa', 'Preparar mapa interactivo con indicadores de seguridad actualizados'], linkedAlertId: 'alt-01', timeframe: 'Próximas 6 horas' },
    { id: 'rec-video-critico', title: 'Contención de video crítico sobre gasto de comunicación', category: 'crisis', urgency: 'alta', summary: 'Video de @gdl_critico acumula 8,500 views en 40 min. Réplicas comenzando en TikTok. Evitar respuesta directa que amplifique alcance.', actions: ['NO responder directamente al video (evitar Streisand effect)', 'Producir contenido propio con desglose del gasto en comunicación', 'Activar red de creadores tapatíos aliados con contenido paralelo', 'Monitorear réplicas cada 30 minutos y reportar patrones'], linkedAlertId: 'alt-02', timeframe: 'Próximas 4 horas' },
    { id: 'rec-cabildo', title: 'Anticipar respuesta a bancada MORENA en cabildo', category: 'competencia', urgency: 'media', summary: 'Regidores de MORENA preparan nueva confrontación en la sesión ordinaria de mañana. Anticiparse con datos y respuesta política.', actions: ['Preparar carpeta con avances por eje para cada regidor de MC', 'Coordinar mensaje con dirigencia estatal del partido', 'Convocar a medios locales con anticipación al inicio de la sesión'], linkedAlertId: 'alt-03', timeframe: 'Mañana' },
    { id: 'rec-prensa-regional', title: 'Amplificar cobertura de El Informador sobre agua', category: 'narrativa', urgency: 'baja', summary: 'El Informador dio cobertura positiva al eje de agua. Momento oportuno para consolidar posicionamiento en el tema estrella de la administración.', actions: ['Compartir la nota en redes propias con quote seleccionada', 'Enviar agradecimiento privado y ofrecer entrevistas de seguimiento', 'Producir hilo en X con datos duros del plan hidráulico'], linkedAlertId: 'alt-04', timeframe: 'Esta semana' },
    { id: 'rec-narrativa-2027', title: 'Blindar narrativa de gestión rumbo a 2027', category: 'narrativa', urgency: 'media', summary: 'Reforma cuestiona resultados MC vs. MORENA rumbo al proceso 2027. Articular narrativa de gestión con datos duros antes de que escale.', actions: ['Preparar informe visual del primer año de gobierno por eje', 'Rueda de prensa mensual para consolidar presencia mediática', 'Alianzas con analistas y líderes de opinión clave'], linkedAlertId: 'alt-05', timeframe: 'Próximo mes' },
    { id: 'rec-contenido', title: 'Fortalecer contenido institucional en formato Reel', category: 'contenido', urgency: 'baja', summary: 'Reel institucional sobre agua alcanzó 25k views. Oportunidad de sistematizar contenido por cada eje de gobierno.', actions: ['Calendario semanal de Reels por eje (agua, limpia, seguridad, etc.)', 'Testimonios ciudadanos como formato principal', 'Historias diarias con avances territoriales'], linkedAlertId: 'alt-06', timeframe: 'Continuo' },
  ],
  suggestedActions: [
    { title: 'Publicar cronograma de operativos en el oriente', time: 'Hoy · 12:00 PM' },
    { title: 'Rueda de prensa con Comisaría municipal', time: 'Hoy · 02:00 PM' },
    { title: 'Reel sobre avances de agua', time: 'Hoy · 04:00 PM' },
    { title: 'Monitoreo de menciones en X y TikTok', time: 'Continuo' },
  ],
  recentMentions: [
    { user: '@tapatia_ciudadana', platform: 'x', text: 'Buena la gestión de @veronicadelgadillo en agua. Se nota la mejora en mi colonia.', sentiment: 'positivo', time: 'Hace 3 min', engagement: 234 },
    { user: 'María Fernanda Ruiz', platform: 'facebook', text: 'Excelente iniciativa de la alcaldesa con la limpieza del centro. Se agradece.', sentiment: 'positivo', time: 'Hace 8 min', engagement: 189 },
    { user: '@informador_jal', platform: 'x', text: 'Delgadillo presenta avances del plan de servicios municipales.', sentiment: 'neutral', time: 'Hace 12 min', engagement: 156 },
    { user: '@analista_jalisco', platform: 'x', text: 'La primera presidenta electa de GDL consolida narrativa de servicios como bandera.', sentiment: 'positivo', time: 'Hace 18 min', engagement: 421 },
    { user: 'Jorge Serna', platform: 'facebook', text: 'En seguridad hay que ver más resultados. Oblatos sigue muy inseguro.', sentiment: 'negativo', time: 'Hace 24 min', engagement: 830 },
    { user: '@rocio_reportera', platform: 'instagram', text: 'Cobertura del recorrido de Delgadillo en el corredor Chapultepec.', sentiment: 'positivo', time: 'Hace 32 min', engagement: 692 },
    { user: '@encuestas_norte', platform: 'x', text: 'Encuesta ubica a Delgadillo entre las mejores alcaldesas evaluadas de la ZMG.', sentiment: 'positivo', time: 'Hace 41 min', engagement: 567 },
    { user: 'Ernesto Padilla', platform: 'facebook', text: 'Ojalá se cumplan las obras de agua prometidas en el sur de la ciudad.', sentiment: 'neutral', time: 'Hace 55 min', engagement: 98 },
  ],
  sentimentByArea: [
    { area: 'Centro Histórico',   positive: 72, neutral: 18, negative: 10, mentions: 5820, trend: '+4.6 pts' },
    { area: 'Colonia Americana',  positive: 78, neutral: 15, negative: 7,  mentions: 4620, trend: '+3.9 pts' },
    { area: 'Providencia',        positive: 74, neutral: 18, negative: 8,  mentions: 3410, trend: '+3.2 pts' },
    { area: 'Chapultepec',        positive: 76, neutral: 17, negative: 7,  mentions: 2840, trend: '+3.8 pts' },
    { area: 'Oblatos',            positive: 42, neutral: 28, negative: 30, mentions: 1950, trend: '-2.2 pts' },
    { area: 'Cerro del Cuatro',   positive: 48, neutral: 26, negative: 26, mentions: 1580, trend: '-1.4 pts' },
    { area: 'Miravalle',          positive: 45, neutral: 28, negative: 27, mentions: 1210, trend: '-1.8 pts' },
    { area: 'Huentitán',          positive: 62, neutral: 22, negative: 16, mentions: 940,  trend: '+1.4 pts' },
  ],
  sentimentByTopic: [
    { topic: 'Agua', positive: 68, neutral: 20, negative: 12 },
    { topic: 'Servicios básicos', positive: 65, neutral: 22, negative: 13 },
    { topic: 'Ciudad limpia', positive: 62, neutral: 25, negative: 13 },
    { topic: 'Seguridad', positive: 32, neutral: 30, negative: 38 },
    { topic: 'Empleo', positive: 55, neutral: 27, negative: 18 },
    { topic: 'Comunicación oficial', positive: 38, neutral: 30, negative: 32 },
  ],
};

// ═══════════════════════════════════════════════════════════════════
// MÓNICA KLEOPATRA SANDOVAL DÍAZ — Aspirante a Presidencia Municipal
// de Zapopan · MORENA · Hermana del ex-gobernador Aristóteles Sandoval
// ═══════════════════════════════════════════════════════════════════
const monicaSandoval: Profile = {
  slug: 'monica-sandoval',
  candidate: {
    name: 'Mónica Kleopatra Sandoval Díaz',
    role: 'Candidata a la Presidencia Municipal de Zapopan',
    verified: true,
    coalicion: 'MORENA',
    eleccion: 'Municipal 2027',
    diasParaEleccion: 271,
    photoInitials: 'MS',
    photoUrl: '/candidates/monica-sandoval.png',
  },
  candidateScope: {
    level: 'municipal',
    area: 'Zapopan',
  ...
  topNews: [
    { title: 'Noticieros Televisa: Sandoval formaliza aspiración a la alcaldía de Zapopan', source: 'Noticieros Televisa', tier: 'nacional-tv', time: '10:02 AM', sentiment: 'POSITIVA' },
    { title: 'Reforma: legado de Aristóteles Sandoval y proyección política de su hermana', source: 'Reforma', tier: 'nacional-print', time: '09:15 AM', sentiment: 'NEUTRAL' },
    { title: 'El Informador: MORENA arma agenda territorial en Zapopan con Sandoval', source: 'El Informador', tier: 'regional', time: '08:40 AM', sentiment: 'POSITIVA' },
  ],
  allNews: [
    { title: 'Noticieros Televisa: Sandoval formaliza aspiración a la alcaldía de Zapopan', source: 'Noticieros Televisa', tier: 'nacional-tv', time: '10:02 AM', sentiment: 'POSITIVA', summary: 'Cobertura en horario estelar. La aspirante detalló ejes de seguridad, movilidad y agua para el segundo municipio más grande de Jalisco.' },
    { title: 'TV Azteca abre noticiario con evento de Sandoval en el Bosque del Centinela', source: 'Hechos AM · TV Azteca', tier: 'nacional-tv', time: '07:20 AM', sentiment: 'POSITIVA', summary: 'Nota de dos minutos con arranque de precampaña en zonas de reserva ecológica y encuentros con vecinos.' },
    { title: 'Reforma: legado de Aristóteles Sandoval y proyección política de su hermana', source: 'Reforma', tier: 'nacional-print', time: '09:15 AM', sentiment: 'NEUTRAL', summary: 'Análisis del posicionamiento de la aspirante y su vínculo familiar con el ex-gobernador de Jalisco.' },
    { title: 'El Universal: MORENA busca recuperar Zapopan de Movimiento Ciudadano', source: 'El Universal', tier: 'nacional-print', time: '06:45 AM', sentiment: 'POSITIVA', summary: 'Reportaje sobre la estrategia del partido para disputar el segundo municipio más importante de Jalisco al emecismo.' },
    { title: 'Milenio: encuesta ubica a Sandoval en tercer lugar en la ZMG', source: 'Milenio', tier: 'nacional-print', time: '08:15 AM', sentiment: 'NEUTRAL', summary: 'Última medición la coloca detrás de Frangie (MC) pero con margen de crecimiento entre indecisos.' },
    { title: 'El Informador: MORENA arma agenda territorial en Zapopan con Sandoval', source: 'El Informador', tier: 'regional', time: '08:40 AM', sentiment: 'POSITIVA', summary: 'Cobertura del arranque de recorridos en zonas del norte y del poniente del municipio.' },
    { title: 'NTR Guadalajara: cuestionan continuismo político por vínculo familiar', source: 'NTR Guadalajara', tier: 'regional', time: '09:15 AM', sentiment: 'NEGATIVA', summary: 'Analistas señalan riesgo de percepción de "dinastía política" en la aspiración de la hermana del ex-gobernador.' },
    { title: 'UdeG Radio: foro estudiantil sobre alternativas políticas en Zapopan', source: 'UdeG Radio', tier: 'digital-medio', time: '06:20 AM', sentiment: 'NEUTRAL', summary: 'Universitarios organizan foro con presencia de aspirantes de distintos partidos a la alcaldía de Zapopan.' },
    { title: 'Influencer viraliza crítica al legado de Aristóteles en Jalisco', source: '@zpn_critico · X', tier: 'influencer', time: '05:40 AM', sentiment: 'NEGATIVA', summary: 'Publicación de creador con 150k seguidores relaciona a la aspirante con etapas polémicas del ex-gobernador.' },
  ],
  topics: [
    { name: 'Aspiración a alcaldía', mentions: 4820, sentiment: 55, positive: true },
    { name: 'Vínculo familiar con Aristóteles', mentions: 3480, sentiment: -28, positive: false },
    { name: 'Seguridad en Zapopan', mentions: 3210, sentiment: 42, positive: true },
    { name: 'Movilidad y bosques', mentions: 2810, sentiment: 62, positive: true },
    { name: 'Contra MC (Frangie)', mentions: 1920, sentiment: 38, positive: true },
  ],
  wordCloud: [
    { text: 'zapopan', value: 100, color: '#a855f7' },
    { text: 'seguridad', value: 88, color: '#22c55e' },
    { text: 'candidata', value: 78, color: '#ec4899' },
    { text: 'morena', value: 68, color: '#8b0000' },
    { text: 'movilidad', value: 62, color: '#3b82f6' },
    { text: 'bosques', value: 55, color: '#22c55e' },
    { text: 'vecinos', value: 50, color: '#eab308' },
    { text: 'agua', value: 48, color: '#3b82f6' },
    { text: 'ciudadanos', value: 44, color: '#eab308' },
    { text: 'cambio', value: 40, color: '#22c55e' },
    { text: 'jalisco', value: 34, color: '#ff6b00' },
    { text: 'territorio', value: 30, color: '#a855f7' },
    { text: 'ecología', value: 28, color: '#22c55e' },
    { text: 'transparencia', value: 26, color: '#eab308' },
    { text: 'compromiso', value: 24, color: '#3b82f6' },
    { text: 'oposición', value: 20, color: '#f97316' },
  ],
  alerts: [
    { id: 'alt-01', what: 'Menciones críticas por vínculo familiar con Aristóteles Sandoval', who: 'Analistas locales + medios digitales', risk: 'Alto · narrativa de "dinastía política"', time: 'Hace 15 min', severity: 'orange', recommendationId: 'rec-dinastia' },
    { id: 'alt-02', what: 'Video crítico sobre legado de ex-gobernador toma alcance en X', who: 'Creador @zpn_critico (150k seguidores)', risk: 'Medio · viralización probable en 6h', time: 'Hace 42 min', severity: 'yellow', recommendationId: 'rec-video-critico' },
    { id: 'alt-03', what: 'Frangie (MC) anuncia informe de gobierno con presencia masiva', who: 'Alcalde actual de Zapopan · mañana 6:00 PM', risk: 'Bajo · disputa de agenda mediática', time: 'Hace 1 h', severity: 'blue', recommendationId: 'rec-competencia' },
  ],
  allAlerts: [
    { id: 'alt-01', what: 'Menciones críticas por vínculo familiar con ex-gobernador (+45% en la última hora, 2,340 menciones)', who: 'Analistas locales + medios digitales fronterizos · NTR Guadalajara', risk: 'Alto · narrativa de "dinastía política" · escala a nacional', zone: 'Jalisco', time: 'Hace 15 min', severity: 'orange', recommendationId: 'rec-dinastia' },
    { id: 'alt-02', what: 'Video crítico sobre legado de ex-gobernador: 11,200 views en 40 minutos', who: 'Creador @zpn_critico (150k seguidores) + réplicas en TikTok', risk: 'Medio · viralización probable en 6h', zone: 'Digital', time: 'Hace 42 min', severity: 'yellow', recommendationId: 'rec-video-critico' },
    { id: 'alt-03', what: 'Frangie (MC) anuncia informe de gobierno con presencia masiva (~8,000 asistentes)', who: 'Alcalde actual de Zapopan · Movimiento Ciudadano · mañana 6:00 PM', risk: 'Bajo · disputa de agenda mediática del día', zone: 'Zapopan', time: 'Hace 1 h', severity: 'blue', recommendationId: 'rec-competencia' },
    { id: 'alt-04', what: 'Encuesta de Milenio ubica a Sandoval en tercer lugar en la ZMG', who: 'Milenio + casa encuestadora nacional', risk: 'Medio · necesita cierre de brecha vs. líder', zone: 'Nacional', time: 'Hace 2 h', severity: 'yellow', recommendationId: 'rec-crecimiento' },
    { id: 'alt-05', what: 'Cobertura positiva de El Informador sobre agenda territorial', who: 'El Informador · sección Jalisco', risk: 'Bajo · oportunidad de amplificar mensaje', zone: 'Jalisco', time: 'Hace 3 h', severity: 'blue', recommendationId: 'rec-prensa-regional' },
    { id: 'alt-06', what: 'Cuadros medios de MORENA-Jalisco piden claridad en proceso interno', who: 'Militancia y liderazgos regionales del partido', risk: 'Medio · afecta narrativa de unidad', zone: 'MORENA', time: 'Hace 4 h', severity: 'yellow', recommendationId: 'rec-unidad-morena' },
  ],
  recommendations: [
    { id: 'rec-dinastia', title: 'Blindar narrativa frente a percepción de "dinastía política"', category: 'crisis', urgency: 'alta', summary: 'Menciones críticas por vínculo familiar con Aristóteles Sandoval crecen +45% en 1 hora. Necesitamos separar identidad política propia antes de que escale.', actions: ['Publicar exposición de trayectoria propia con hitos claros', 'Rueda de prensa técnica enfocada en propuestas concretas para Zapopan', 'Coordinar entrevistas con El Informador y Milenio Jalisco', 'Preparar hilo en X con propuestas ecológicas y de movilidad'], linkedAlertId: 'alt-01', timeframe: 'Próximas 6 horas' },
    { id: 'rec-video-critico', title: 'Contención de video crítico sobre legado familiar', category: 'crisis', urgency: 'alta', summary: 'Video de @zpn_critico acumula 11,200 views en 40 min. Réplicas comenzando en TikTok. Evitar respuesta directa que amplifique alcance.', actions: ['NO responder directamente al video (evitar Streisand effect)', 'Producir contenido propio con testimonios de trayectoria personal', 'Activar red de creadores tapatíos aliados con contenido paralelo', 'Monitorear réplicas cada 30 minutos y reportar patrones'], linkedAlertId: 'alt-02', timeframe: 'Próximas 4 horas' },
    { id: 'rec-competencia', title: 'Contra-agenda por informe de Frangie', category: 'competencia', urgency: 'media', summary: 'Frangie (MC) convoca informe con ~8,000 asistentes mañana 6:00 PM. Necesitamos ocupar el ciclo mediático del día en Zapopan.', actions: ['Agendar recorrido territorial paralelo en zonas populares del municipio', 'Anunciar propuesta concreta con embargo periodístico para las 5:00 PM', 'Convocar a medios locales (Milenio Jalisco, El Informador, NTR) con anticipación'], linkedAlertId: 'alt-03', timeframe: 'Mañana' },
    { id: 'rec-crecimiento', title: 'Estrategia de crecimiento entre indecisos', category: 'narrativa', urgency: 'media', summary: 'Encuesta ubica a Sandoval en tercer lugar. El margen de crecimiento está entre indecisos (28% del padrón). Focalizar esfuerzos.', actions: ['Encuesta interna focalizada en indecisos por colonia', 'Contenido específico para audiencia joven en TikTok e Instagram', 'Alianzas con liderazgos vecinales de zonas de baja penetración'], linkedAlertId: 'alt-04', timeframe: 'Próximas 48 horas' },
    { id: 'rec-prensa-regional', title: 'Amplificar cobertura de El Informador', category: 'narrativa', urgency: 'baja', summary: 'El Informador dio cobertura positiva a la agenda territorial. Momento oportuno para consolidar posicionamiento en Jalisco.', actions: ['Compartir la nota en redes propias con quote seleccionada', 'Enviar agradecimiento privado y ofrecer seguimiento', 'Producir 3 piezas de contenido derivadas (video, carrusel, hilo)'], linkedAlertId: 'alt-05', timeframe: 'Esta semana' },
    { id: 'rec-unidad-morena', title: 'Blindar narrativa de unidad en MORENA-Jalisco', category: 'narrativa', urgency: 'media', summary: 'Cuadros medios del partido en Jalisco piden claridad sobre el proceso interno. Anticiparse antes de que escale a fricción pública.', actions: ['Agendar reuniones privadas con liderazgos regionales', 'Publicar mensaje de unidad con respaldo de figuras nacionales', 'Coordinar comunicado con dirigencia estatal'], linkedAlertId: 'alt-06', timeframe: 'Próximas 48 horas' },
  ],
  suggestedActions: [
    { title: 'Publicar trayectoria política propia', time: 'Hoy · 12:00 PM' },
    { title: 'Coordinar entrevista con El Informador', time: 'Hoy · 02:00 PM' },
    { title: 'Recorrido territorial en zona norte', time: 'Hoy · 04:00 PM' },
    { title: 'Monitoreo de menciones en X y TikTok', time: 'Continuo' },
  ],
  recentMentions: [
    { user: '@zapopana', platform: 'x', text: 'Buena la propuesta de Sandoval sobre cuidar los bosques de Zapopan. Hace falta esa agenda.', sentiment: 'positivo', time: 'Hace 3 min', engagement: 234 },
    { user: 'María Fernanda Ruiz', platform: 'facebook', text: 'No me convence que sea hermana del ex-gobernador. Prefiero perfiles nuevos.', sentiment: 'negativo', time: 'Hace 8 min', engagement: 189 },
    { user: '@informador_jal', platform: 'x', text: 'Sandoval arranca recorridos territoriales en Zapopan rumbo al 2027.', sentiment: 'neutral', time: 'Hace 12 min', engagement: 156 },
    { user: '@analista_jalisco', platform: 'x', text: 'MORENA busca dar batalla en Zapopan con Sandoval. Habrá que ver estrategia.', sentiment: 'neutral', time: 'Hace 18 min', engagement: 421 },
    { user: 'Jorge Serna', platform: 'facebook', text: 'El apellido Sandoval pesa mucho, para bien y para mal. Va a depender de la campaña.', sentiment: 'neutral', time: 'Hace 24 min', engagement: 830 },
    { user: '@rocio_reportera', platform: 'instagram', text: 'Cobertura del evento de Sandoval en el Bosque del Centinela: buena convocatoria.', sentiment: 'positivo', time: 'Hace 32 min', engagement: 692 },
    { user: '@encuestas_norte', platform: 'x', text: 'Encuesta ubica a Sandoval en tercer lugar en Zapopan, con margen de crecimiento entre indecisos.', sentiment: 'neutral', time: 'Hace 41 min', engagement: 567 },
    { user: 'Ernesto Padilla', platform: 'facebook', text: 'Frangie está bien posicionado, será difícil desplazarlo. A ver qué propone Sandoval.', sentiment: 'neutral', time: 'Hace 55 min', engagement: 98 },
  ],
  sentimentByArea: [
    { area: 'Centro de Zapopan',     positive: 58, neutral: 24, negative: 18, mentions: 6820, trend: '+2.6 pts' },
    { area: 'Andares · Puerta Plata', positive: 42, neutral: 28, negative: 30, mentions: 4180, trend: '-1.4 pts' },
    { area: 'Ciudad Granja',         positive: 52, neutral: 26, negative: 22, mentions: 3210, trend: '+1.2 pts' },
    { area: 'La Estancia',           positive: 48, neutral: 27, negative: 25, mentions: 2440, trend: '+0.6 pts' },
    { area: 'Base Aérea',            positive: 62, neutral: 22, negative: 16, mentions: 1650, trend: '+3.4 pts' },
    { area: 'Tesistán',              positive: 65, neutral: 21, negative: 14, mentions: 1240, trend: '+3.8 pts' },
    { area: 'Nextipac',              positive: 68, neutral: 20, negative: 12, mentions: 980,  trend: '+4.2 pts' },
    { area: 'Copala',                positive: 55, neutral: 25, negative: 20, mentions: 810,  trend: '+1.8 pts' },
  ],
  sentimentByTopic: [
    { topic: 'Ecología y bosques', positive: 68, neutral: 20, negative: 12 },
    { topic: 'Seguridad', positive: 52, neutral: 26, negative: 22 },
    { topic: 'Movilidad', positive: 58, neutral: 25, negative: 17 },
    { topic: 'Agua', positive: 55, neutral: 27, negative: 18 },
    { topic: 'Vínculo familiar', positive: 28, neutral: 30, negative: 42 },
    { topic: 'Continuismo político', positive: 32, neutral: 30, negative: 38 },
  ],
};
...
export const profiles: Profile[] = [esthela, torres, arambula, meryPozos, lauraPerez, ricardoMonreal, ismaelBurgueno, veronicaDelgadillo, monicaSandoval];
